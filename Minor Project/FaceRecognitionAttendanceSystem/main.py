...
while True:
    ...
    if faceCurFrame:
        ...
        for encodeFace , faceLoc in zip(encodeCurFrame , faceCurFrame):
            ...
            if matches[matchIndex]:
                ...
                if counter == 0:
                    ...
                    cv2.imshow("FaceRec Attendance", imgBackground)
                    cv2.waitKey(1)
                    counter = 1
                    modeType = 1
        ...
        if counter != 0:
            ...
            if counter == 1:
                #Getting the Data from rt Database
    ...
    cv2.imshow("FaceRec Attendance", imgBackground)
    cv2.waitKey(1)
    if cv2.getWindowProperty("FaceRec Attendance", cv2.WND_PROP_VISIBLE) < 1:
        break
